 ...
 */
public class palveluRaporttiGUI extends MainUI{
    ...
    public void modifyRightPanel(JPanel rightSidePanel){
        ...
        lblOtsikko = new JLabel ("PALVELUIDEN RAPORTOINTI");
...
rightSidePanel.add(lblOtsikko);
		...
		public void actionPerformed(ActionEvent actEvent) {	
                    try {
                        palveluRaportti.raportti(m_conn, Integer.parseInt(txtToimipisteID.getText()), txtAloitus.getText(), txtLopetus.getText());
                    } catch (Exception ex) {
...
public void actionPerformed(ActionEvent actEvent) {	
            try {
                palveluRaportti.raportti2(m_conn, Integer.parseInt(txtToimipisteID.getText()), txtPaiva.getText());
            } catch (Exception ex) {
                Logger.getLogger(hallintaGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
}
